...
int main() {
  std::vector<unsigned char> client_hello = {0x16, 0x03, 0x01, 0x00, 0x3c, 0x01,
                                             0x00, 0x00, 0x38, 0x03, 0x03};
  client_hello.insert(client_hello.end(), 32, 0x00);
  client_hello.insert(client_hello.end(),
                      {0x00, 0x00, 0x02, 0x13, 0x01, 0x01, 0x00, 0x00,
                       0x0d, 0x00, 0x00, 0x00, 0x09, 0x00, 0x07, 0x00,
